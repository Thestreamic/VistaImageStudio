...
export function AiPanel() {
  ...
  const btnBase = 'w-full flex items-center gap-2 px-2.5 py-2 text-xs rounded-md bg-secondary hover:bg-secondary/80 disabled:opacity-40 disabled:pointer-events-none transition-colors'
      ...
      <div>
        ...
        <div className="mt-2 space-y-1.5">
          <button
            ...
            className="w-full flex items-center gap-2 px-2.5 py-2.5 text-xs rounded-md brand-gradient-bg text-white font-semibold disabled:opacity-40 disabled:pointer-events-none"
